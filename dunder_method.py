...
class TicketData:
    def __init__(self, ticket_number: str,task_number: str,tasked_user: str,task_title: str,task_description: str,date_time_assigned: str,due_date: str,completed_yes_no: str):
...
class TaskTicket(TicketData):
    def __init__(self,ticket_number,task_number,tasked_user,task_title,task_description,date_time_assigned,due_date,completed_yes_no):
        super().__init__(ticket_number,task_number,tasked_user,task_title,task_description,date_time_assigned,due_date,completed_yes_no)
        return print(
